                  ...
                  <tr key={v.vendaLoteId} className="transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                    ...
                    <td className="px-4 py-3 text-right">
                      <a
                        ...
                        className="inline-flex items-center gap-1 rounded-md border border-zinc-300 px-2.5 py-1 text-xs font-medium text-zinc-700 transition-colors hover:border-zinc-400 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800"
                      >
                        PDF ↓
                      </a>
                    </td>
