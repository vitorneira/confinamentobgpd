      ...
      <main className="w-full max-w-2xl">
        <div className="mb-8 flex items-center justify-between">
          ...
          <form action={signOut}>
            <button
              type="submit"
              className="rounded-input border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-900"
            >
              Sair
            </button>
          </form>
        ...
        <div className="space-y-3">
          ...
          {fazendasComContagem.map((f) => (
            <Link
              ...
              className="flex items-center justify-between rounded-card border border-zinc-200 bg-white p-4 shadow-sm hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:bg-zinc-800"
            >
              <div>
